...
function Library:create_ui()
    ...
    function self:create_tab(title: string, icon: string)
        ...
        Tab.TextSize = 14
        Tab.BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Light gray for tabs
        Tab.Parent = Tabs
        ...
        function TabManager:create_module(settings: any)
            ...
            Module.BackgroundColor3 = Color3.fromRGB(240, 240, 240) -- Light gray for modules
            ...
            local UIStroke = Instance.new('UIStroke')
            UIStroke.Color = Color3.fromRGB(60, 60, 60) -- Dark gray outline for modules
            UIStroke.Transparency = 0.5
            UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
            ...
            ModuleName.TextColor3 = Color3.fromRGB(0, 0, 0)
            ...
            Toggle.BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Light gray for toggle background
            ...
            Circle.BackgroundColor3 = Color3.fromRGB(60, 60, 60) -- Dark gray for toggle circle
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Slider.BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Light gray for slider background
                ...
                Drag.BackgroundColor3 = Color3.fromRGB(60, 60, 60) -- Dark gray for slider bar
                Drag.Parent = Slider
                ...
                Fill.BorderSizePixel = 0
                Fill.BackgroundColor3 = Color3.fromRGB(60, 60, 60) -- Dark gray for slider fill
                Fill.Parent = Drag
                ...
                Circle.BorderSizePixel = 0
                Circle.BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Light gray for slider circle
                Circle.Parent = Fill
            ...
            function ModuleManager:create_feature(settings)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(0, 0, 0) or Color3.fromRGB(32, 38, 51)
                    Checkbox.Text = ""
